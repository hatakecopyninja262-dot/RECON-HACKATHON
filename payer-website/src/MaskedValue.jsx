    ...
    <span className={`inline-flex items-center gap-1.5 ${className}`}>
      ...
      {showReveal && (
        <button
          ...
          className="ml-1 inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-indigo-400 hover:text-indigo-200 border border-indigo-500/30 rounded px-1.5 py-0.5 bg-slate-800/60 hover:bg-slate-700/60 transition-colors"
        >
